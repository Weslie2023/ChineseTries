...
import java.util.regex.Pattern;
    ...
    public class ShuangPinTrieOrigin {
...
//    }
    ...
    ShuangPinTrie test=new ShuangPinTrie();
    test.insertAll();
    System.out.println(test.search("miao1"));
        System.out.println(getAllShuangpin());
    }
